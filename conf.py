...
html_context = {'versions': [('1.0', '1.0/'), ('latest', '')], 'downloads': [('HTML', '../files/twoears-auditory-model.html'), ('PDF', '../files/twoears-auditory-model.pdf')]}
...
.. |LatestVersion| replace:: `latest version`_
...
.. _latest version: http://twoears.aipa.tu-berlin.de/files/twoears-auditory-model-1.0-rc7.zip
"""
